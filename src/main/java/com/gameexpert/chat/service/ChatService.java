...
public class ChatService {
    ...
    public ChatMessageResponse saveMessage(Long worldId, String sender, String content) {
        ...
        return savedResponse(worldId, chatMessage);
    }
    ...
    public List<ChatMessageResponse> getRecentMessages(Long worldId, int limit) {
        ...
        for(ChatMessage chatMessage : recent){
            chatMessageResponses.add(new ChatMessageResponse(chatMessage.getSenderNickname(), chatMessage.getContent(), chatMessage.getCreatedAt()));
        }
